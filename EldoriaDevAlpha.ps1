...
# EMOJI BANK CLASS
#
# It's likely that this class will never be used since this is one of the
# oldest pieces of code in this codebase, but I'm keeping it around just
# in case.
#
###############################################################################
Class EmojiBank {
...
#
# Static namespace wrapper for common SGR prefixes.
#
# TODO: Remove the static methods. These need moved to other areas.
#
###############################################################################
