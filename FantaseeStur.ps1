...
Class SIFieldNorthRoad : SIInternalBase {
    SIFieldNorthRoad(): base() {
        ...
        $this.ColorMap[47] = [CCPantoneSkyBlue24]::new()
        ...
        $this.ColorMap[95] = [CCPantoneSkyBlue24]::new()
        ...
        $this.ColorMap[143] = [CCPantoneSkyBlue24]::new()
        ...
        $this.ColorMap[191] = [CCPantoneSkyBlue24]::new()
