...
$Script:GhostbustersTheme[0] = [System.Tuple]::Create(($Script:NoteTable[[Notes]::B, [Octaves]::Fifth]), [NoteDuration]::Eighth)
$Script:GhostbustersTheme[0] = [System.Tuple]::Create([Notes]::Rest, [NoteDuration]::Quarter)
$Script:GhostbustersTheme[0] = [System.Tuple]::Create(($Script:NoteTable[[Notes]::A, [Octaves]::Sixth]), [NoteDuration]::Eighth)
$Script:GhostbustersTheme[0] = [System.Tuple]::Create([Notes]::Rest, [NoteDuration]::Eighth)
$Script:GhostbustersTheme[0] = [System.Tuple]::Create(($Script:NoteTable[[Notes]::GSharpOrAFlat, [Octaves]::Sixth]), [NoteDuration]::Quarter)
$Script:GhostbustersTheme[0] = [System.Tuple]::Create([Notes]::Rest, [NoteDuration]::Eighth)
$Script:GhostbustersTheme[0] = [System.Tuple]::Create(($Script:NoteTable[[Notes]::B, [Octaves]::Fifth]), [NoteDuration]::Eighth)
$Script:GhostbustersTheme[0] = [System.Tuple]::Create(($Script:NoteTable[[Notes]::B, [Octaves]::Fifth]), [NoteDuration]::Eighth)
$Script:GhostbustersTheme[0] = [System.Tuple]::Create([Notes]::Rest, [NoteDuration]::Quarter)
